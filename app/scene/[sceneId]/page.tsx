...
export default function ScenePage() {
  ...
  // Auto-attempt deep link on iOS Safari (not IAB)
  useEffect(() => {
    if (env !== "ios") return;
  ...
  const S = {
    ...
    title: {
      fontWeight: 700, fontSize: "1.75rem", letterSpacing: "-0.02em",
      lineHeight: 1.15, color: "#F0EDE8", margin: 0,
    },
    meta: {
      display: "flex", flexDirection: "column" as const, gap: "0.375rem",
    },
    metaRow: {
      fontSize: "0.9375rem", color: "rgba(240,237,232,0.55)",
    },
    divider: {
    ...
    iabSub: {
      ...
      color: "rgba(240,237,232,0.5)", margin: 0,
    },
  };
      ...
      <main style={S.page}>
        ...
        <div style={S.body}>
          ...
          {scene && (
            <>
              {scene.flare && (
                <span style={{ fontSize: "0.8125rem", color: "rgba(240,237,232,0.45)", fontWeight: 500 }}>
                  {FLARE_LABELS[scene.flare] ?? scene.flare}
                </span>
              )}
              ...
              <div style={S.meta}>
                ...
                {goingCount !== null && goingCount > 0 && (
                  <span style={S.metaRow}>{goingCount} going</span>
                )}
              </div>
            </>
          )}
          ...
          {env === "ios-iab" ? (
            <div style={S.iabMsg}>
              <p style={S.iabTitle}>Open in Safari to join</p>
              <p style={S.iabSub}>
            ...
            <>
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <div
                  ref={qrRef}
                  style={{
                    padding: "1.25rem", background: "#080808", borderRadius: "1rem",
            ...
            <>
              <button style={S.btn} onClick={openInApp}>
                Open in ThisFriday
              </button>
